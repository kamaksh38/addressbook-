            ...
            <div class="modal-content">
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['userid']; ?>">
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="file" name="image" class="form-control" required value="<?php echo $erow['image']; ?>">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="firstname" class="form-control" required value="<?php echo $erow['firstname']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="lastname" class="form-control" required value="<?php echo $erow['lastname']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="tel" pattern="^\d{3}-\d{3}-\d{4}$" placeholder="123-456-7890" name="phone" class="form-control" required value="<?php echo $erow['phone']; ?>">
						</div>
					</div>
					<div style="height:10px;"></div>
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="email" pattern="[^ @]*@[^ @]*" name="address" required class="form-control" value="<?php echo $erow['address']; ?>">
						</div>
					</div>
